...
AI 대국은 빠르게 100ms, 보통 300ms, 강하게 1000ms 중 응수 탐색 시간을 선택할 수 있습니다. 일반 리뷰 수는 비교 가능한 등급을 위해 서버 NNUE를 300ms씩 두 번 실행하므로 결과까지 약 600ms 이상 걸릴 수 있습니다. 대국을 끝낸 수나 강제 승패 평가는 cp 손실 대신 제외 사유를 표시합니다.
